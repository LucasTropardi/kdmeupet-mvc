                ...
                <div class="bg-blue-300 shadow sm:rounded-lg p-1.5">
                    <div class="bg-gray-100 shadow sm:rounded-lg p-1.5">
                        ...
                        <div class="text-left py-4 px-6">
                            <a href="?router=Cores/criar" class="block sm:inline-block w-full sm:w-auto uppercase text-white bg-gradient-to-r from-green-500 via-green-600 to-green-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm px-16 py-2.5 text-center">
                                    ...
                                    ?>
                                            <tr class="bg-white border-b hover:bg-gray-50">
                                                ...
                                                <td class="px-6 py-4 text-center">
                                                    <a href="?router=Cores/editar/&id=<?php echo base64_encode($cor['c_id']); ?>" title="Editar" class="text-blue-700 hover:text-white border border-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-1 py-0.5 text-center ml-2 sm:ml-0 me-0.5 mb-0">
                                                        <i class="fa-solid fa-pencil ml-0.5"></i>
                                                    </a>
                                                    <a href="javascript:void(0);" onclick="if(confirm('Deseja realmente excluir esta cor?')){ window.location.href='?router=Cores/deletar/&id=<?php echo base64_encode($cor['c_id']); ?>'; }" title="Excluir" class="text-red-700 hover:text-white border border-red-700 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm px-2 sm:px-2 py-0.5 text-center me-2 mb-2 sm:ml-2">
