    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-gray-100 overflow-hidden shadow-sm sm:rounded-lg mb-12">
            <div class="p-6 text-gray-900 text-center">
                <form action="?router=Racas/store" method="post">
                    <h5 class="mt-2 mb-8 text-3xl font-bold tracking-tight text-gray-900">Cadastrar raça</h5>
                            ...
                            <div class="grid md:grid-cols-2 md:gap-6">
                                <div class="relative z-0 w-full mb-5 group">
                                    ...
                                    <select name="r_tipos" id="r_tipos" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" autofocus required>
                                        ...
                                        ?>
                                                <option value="<?php echo $especie['t_id'] ?>"><?php echo $especie['t_nome'] ?></option>
                                        <?php
                                            }
                                        ?>
                                    </select>
                                ...
                                <div class="relative z-0 w-full mb-5 group">
                                    ...
                                    <input type="text" name="r_nome" id="r_nome" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"  required />
                                </div>
                            </div>
