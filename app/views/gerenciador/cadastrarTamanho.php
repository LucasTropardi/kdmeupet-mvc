    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-gray-100 overflow-hidden shadow-sm sm:rounded-lg mb-12">
            <div class="p-6 text-gray-900 text-center">
                <form action="?router=Tamanhos/store" method="post">
                    <h5 class="mt-2 mb-8 text-3xl font-bold tracking-tight text-gray-900">Cadastrar tamanho</h5>
                    <div class="mt-2 grid grid-cols-12 gap-4 content-center text-left">
                        <div class="col-span-12 md:col-span-12">
                            <div class="relative z-0 w-full mb-5 group">
                                ...
                                <input type="text" name="t_nometm" id="t_nometm" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" required />
                            </div>
